...
#ifdef REGION_ISM2400
#include "RegionISM2400.h"
#define ISM2400_CASE                                 case LORAMAC_REGION_ISM2400:
#define ISM2400_IS_ACTIVE( )                         ISM2400_CASE { return true; }
#define ISM2400_GET_PHY_PARAM( )                     ISM2400_CASE { return RegionISM2400GetPhyParam( getPhy ); }
#define ISM2400_SET_BAND_TX_DONE( )                  ISM2400_CASE { RegionISM2400SetBandTxDone( txDone ); break; }
#define ISM2400_INIT_DEFAULTS( )                     ISM2400_CASE { RegionISM2400InitDefaults( params ); break; }
#define ISM2400_VERIFY( )                            ISM2400_CASE { return RegionISM2400Verify( verify, phyAttribute ); }
#define ISM2400_APPLY_CF_LIST( )                     ISM2400_CASE { RegionISM2400ApplyCFList( applyCFList ); break; }
#define ISM2400_CHAN_MASK_SET( )                     ISM2400_CASE { return RegionISM2400ChanMaskSet( chanMaskSet ); }
#define ISM2400_COMPUTE_RX_WINDOW_PARAMETERS( )      ISM2400_CASE { RegionISM2400ComputeRxWindowParameters( datarate, minRxSymbols, rxError, rxConfigParams ); break; }
#define ISM2400_RX_CONFIG( )                         ISM2400_CASE { return RegionISM2400RxConfig( rxConfig, datarate ); }
#define ISM2400_TX_CONFIG( )                         ISM2400_CASE { return RegionISM2400TxConfig( txConfig, txPower, txTimeOnAir ); }
#define ISM2400_LINK_ADR_REQ( )                      ISM2400_CASE { return RegionISM2400LinkAdrReq( linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed ); }
#define ISM2400_RX_PARAM_SETUP_REQ( )                ISM2400_CASE { return RegionISM2400RxParamSetupReq( rxParamSetupReq ); }
#define ISM2400_NEW_CHANNEL_REQ( )                   ISM2400_CASE { return RegionISM2400NewChannelReq( newChannelReq ); }
#define ISM2400_TX_PARAM_SETUP_REQ( )                ISM2400_CASE { return RegionISM2400TxParamSetupReq( txParamSetupReq ); }
#define ISM2400_DL_CHANNEL_REQ( )                    ISM2400_CASE { return RegionISM2400DlChannelReq( dlChannelReq ); }
#define ISM2400_ALTERNATE_DR( )                      ISM2400_CASE { return RegionISM2400AlternateDr( currentDr, type ); }
#define ISM2400_NEXT_CHANNEL( )                      ISM2400_CASE { return RegionISM2400NextChannel( nextChanParams, channel, time, aggregatedTimeOff ); }
#define ISM2400_CHANNEL_ADD( )                       ISM2400_CASE { return RegionISM2400ChannelAdd( channelAdd ); }
#define ISM2400_CHANNEL_REMOVE( )                    ISM2400_CASE { return RegionISM2400ChannelsRemove( channelRemove ); }
#define ISM2400_APPLY_DR_OFFSET( )                   ISM2400_CASE { return RegionISM2400ApplyDrOffset( downlinkDwellTime, dr, drOffset ); }
#define ISM2400_RX_BEACON_SETUP( )                   ISM2400_CASE { RegionISM2400RxBeaconSetup( rxBeaconSetup, outDr ); break; }
#else
#define ISM2400_IS_ACTIVE( )
#define ISM2400_GET_PHY_PARAM( )
#define ISM2400_SET_BAND_TX_DONE( )
#define ISM2400_INIT_DEFAULTS( )
#define ISM2400_GET_NVM_CTX( )
#define ISM2400_VERIFY( )
#define ISM2400_APPLY_CF_LIST( )
#define ISM2400_CHAN_MASK_SET( )
#define ISM2400_COMPUTE_RX_WINDOW_PARAMETERS( )
#define ISM2400_RX_CONFIG( )
#define ISM2400_TX_CONFIG( )
#define ISM2400_LINK_ADR_REQ( )
#define ISM2400_RX_PARAM_SETUP_REQ( )
#define ISM2400_NEW_CHANNEL_REQ( )
#define ISM2400_TX_PARAM_SETUP_REQ( )
#define ISM2400_DL_CHANNEL_REQ( )
#define ISM2400_ALTERNATE_DR( )
#define ISM2400_NEXT_CHANNEL( )
#define ISM2400_CHANNEL_ADD( )
#define ISM2400_CHANNEL_REMOVE( )
#define ISM2400_APPLY_DR_OFFSET( )
#define ISM2400_RX_BEACON_SETUP( )
#endif
...
void RegionComputeRxWindowParameters( LoRaMacRegion_t region, int8_t datarate, uint8_t minRxSymbols, uint32_t rxError, RxConfigParams_t *rxConfigParams )
{
    switch( region )
    {
        ...
        ISM2400_COMPUTE_RX_WINDOW_PARAMETERS( );
        default:
        {
            break;
        }
