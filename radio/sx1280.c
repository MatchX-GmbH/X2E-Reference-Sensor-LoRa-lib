 ...
 */
// { Address, RegValue }
#define RADIO_INIT_REGISTERS_VALUE  { {0,0} }
...
void SX1280Init( DioIrqHandler irqHandlers )
{
    SX1280HalInit();
...
{
  if (SX1280GetOperatingMode() == MODE_SLEEP) {
    SX1280HalWakeup();
  }
  SX1280HalWaitOnBusy();
}
...
void SX1280SetSleep( SleepParams_t sleepConfig )
{
    ...
    SX1280SetOperatingMode(MODE_SLEEP);
...
void SX1280SetFs( void )
{
    ...
    SX1280SetOperatingMode(MODE_FS);
}
...
void SX1280SetTx( TickTime_t timeout )
{
    ...
    SX1280SetOperatingMode(MODE_TX);
}
...
void SX1280SetRx( TickTime_t timeout )
{
    ...
    SX1280SetOperatingMode(MODE_RX);
}
...
void SX1280SetCad( void )
{
    ...
    SX1280SetOperatingMode(MODE_CAD);
}
